...
```bash
cookiecutter gh:dimasmoosa/cookiecutter-datascience-simple
```
...
For the remote repository, make a github repository named HW1_KC_HouseSales, then do;

```bash
git remote add origin git@github.com:dimasmoosa/HW1_KC_HouseSales.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── HW1_KC_HouseSales	<- Your notebooks and scripts will live in the main project folder
